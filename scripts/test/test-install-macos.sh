...
plist="$home_dir/Library/LaunchAgents/com.max.agentdock.plist"
...
test ! -e "$home_dir/Library/LaunchAgents/com.max.agentdock.cloudflared.plist"
...
tunnel_plist="$home_dir/Library/LaunchAgents/com.max.agentdock.cloudflared.plist"
...
test ! -e "$partial_home/Library/LaunchAgents/com.max.agentdock.plist"
...
service_plist="$service_home/Library/LaunchAgents/com.max.agentdock.plist"
